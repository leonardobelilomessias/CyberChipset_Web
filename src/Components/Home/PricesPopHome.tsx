...
export function PricesPopHome({products}:ProductsProps){
  ...
  return(
      ...
      <Col css={{mb:100 }} >
      <Row css={{mt:50 ,p:0}} justify="center">
        <SmileySticker  size={62}  color="#7828C8" weight="duotone" />
        
        </Row>
        
      <Row justify="center">

        <Text  weight={"bold"} color={"black"}id="price"  size={"$5xl"} css={{textAlign:"center" }} >
          Linha Pop
        </Text>
      </Row>
      <Row css={{p:0, display:"flex"}} justify="center">
        <Text  weight={"bold"} color={"$gray700"}id="price"  css={{textAlign:"center" }}  size={"$3xl"}>
        O melhor custo benefício da tecnologia.
        </Text>
      </Row>
      </Col>
      <Row css={{m:10,mb:200}}>
